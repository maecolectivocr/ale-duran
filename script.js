...
(function () {
  ...
  var I18N = {
    es: {
      ...
      'about.p1': 'Ale Durán es cantante en vivo radicada en el Pacífico de Costa Rica. Su sello es la cercanía: interpretaciones cuidadas, en voz y guitarra, que acompañan sin competir con la conversación. Del atardecer en la terraza al brindis de una boda, construye la banda sonora del momento.',
      'about.p2': 'Con presencia constante en los mejores spots de Jacó, Herradura y Hermosa, hoy lleva su propuesta a hoteles boutique, marinas y venues de primer nivel del país.',
      ...
      'rep.c1t': 'Bossa & Lounge', 'rep.c1p': 'Clásicos brasileños y jazz suave para cócteles, cenas y atardeceres frente al mar.',
      'rep.c2t': 'Acústico en español', 'rep.c2p': 'Pop latino y baladas reinterpretadas en voz y guitarra, cálidas y cercanas.',
      'rep.c3t': 'Soul & Pop en inglés', 'rep.c3p': 'Standards modernos y soul atemporal para un público internacional.',
      'rep.c4t': 'Boleros & clásicos', 'rep.c4p': 'El romanticismo de siempre para primeras danzas y momentos especiales.',
      'rep.formatsTitle': 'Formatos disponibles',
      'rep.f1': 'Voz & guitarra. Íntimo y versátil.', 'rep.f2': 'Voz con guitarra o piano acompañante.',
      'rep.f3name': 'Banda', 'rep.f3': 'Formato ampliado para fiestas y grandes celebraciones.',
    ...
    en: {
      ...
      'about.p1': "Ale Durán is a live singer based on Costa Rica's Pacific coast. Her signature is closeness: refined performances on voice and guitar that accompany without competing with the conversation. From a sunset on the terrace to a wedding toast, she builds the soundtrack of the moment.",
      'about.p2': 'A constant presence at the best spots in Jacó, Herradura and Hermosa, she now brings her act to boutique hotels, marinas and the country’s top-tier venues.',
      ...
      'rep.c1t': 'Bossa & Lounge', 'rep.c1p': 'Brazilian classics and smooth jazz for cocktails, dinners and beachfront sunsets.',
      'rep.c2t': 'Acoustic in Spanish', 'rep.c2p': 'Latin pop and ballads reimagined on voice and guitar — warm and close.',
      'rep.c3t': 'Soul & Pop in English', 'rep.c3p': 'Modern standards and timeless soul for an international crowd.',
      'rep.c4t': 'Boleros & classics', 'rep.c4p': 'Timeless romance for first dances and special moments.',
      'rep.formatsTitle': 'Available formats',
      'rep.f1': 'Voice & guitar. Intimate and versatile.', 'rep.f2': 'Voice with guitar or accompanying piano.',
      'rep.f3name': 'Band', 'rep.f3': 'Expanded format for parties and large celebrations.',
